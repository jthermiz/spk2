...
ops.fbinary             = fullfile(cfg.filepath, 'experiment.dat'); % will be created for 'openEphys'		
ops.fproc               = fullfile(cfg.path_name, 'temp_wh.dat'); % residual from RAM of preprocessed data		
ops.root                = cfg.filepath; % 'openEphys' only: where raw files are		

% define the channel map as a filename (string) or simply an array		
ops.chanMap             = fullfile(cfg.path_name, 'chanMap.mat'); % make this file using createChannelMapFile.m		
...
ops.Nfilt               = ceil(ops.Nchan*2/32)*32;  % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
